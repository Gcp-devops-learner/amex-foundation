output "nonprod-e1-vpc" {
  value       = module.vpc.network_name
  description = "shared vpc  id"
}

output "nonprod-e1-vpc-link" {
  value       = module.vpc.network_self_link
  description = "shared vpc id link"
}
/*
output "nonprod_vpn_gateway_e_name" {
  value       = google_compute_ha_vpn_gateway.nonprod_e1_vpn_gateway_east.self_link
  description = "nonprod vpn name"
}

output "nonprod_vpn_gateway_c_name" {
  value       = google_compute_ha_vpn_gateway.nonprod_e1_vpn_gateway_central.self_link
  description = "nonprod vpn name"
}
