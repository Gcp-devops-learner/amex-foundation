...
variable "anon_router_east_asn" {
  type = string
}

variable "anon_router_central_asn" {
  type = string
  
}

variable "anon_east_cloud_router_name" {
  type = string
  
}

variable "anon_central_cloud_router_name" {
  type = string
