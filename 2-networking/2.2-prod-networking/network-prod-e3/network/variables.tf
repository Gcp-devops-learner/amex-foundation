...
variable "e3_east_cloud_router_name" {
  type = string
  
}

variable "e3_central_cloud_router_name" {
  type = string
}
...
variable "e3_router_central_asn" {
    type = number
    description = "ASN number of the cloud router"
    default = 0
}

variable "e3_router_east_asn" {
    type = number
    description = "ASN number of the cloud router"
    default = 0
}
