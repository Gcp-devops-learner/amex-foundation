...
variable "ss_router_east_asn" {
  type = string
}

variable "ss_router_central_asn" {
  type = string
  
}

variable "ss_east_cloud_router_name" {
  type = string
  
}

variable "ss_central_cloud_router_name" {
  type = string
  
}

variable "ss_east_cloud_inter_connect_router_name" {
  type = string
}

variable "ss_central_cloud_inter_connect_router_name" {
  type = string
}
